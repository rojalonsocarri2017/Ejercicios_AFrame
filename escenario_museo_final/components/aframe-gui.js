...
/***/ (function(module, exports, __webpack_require__) {
    ...
    console.log('RAC INICIOOOOOOOOOO');
    ...
    */
    ...
    AFRAME.registerComponent('gui-radio', {
        ...
        init: function init() {
            console.log('RAC ESTOY EN INIT RADIO');
            var data = this.data;
            var el = this.el;
            var guiItem = el.getAttribute("gui-item");
            this.guiItem = guiItem;
            ...
            el.addEventListener(data.on, function (evt) {
                ...
                if (!data.checked) {
                    ...
                    console.log("PASO CHECKED 22222")
        ...
        update: function update() {
            console.log('RAC ESTOY EN UPDATE RADIO');
            var data = this.data;
            var el = this.el;
            this.updateToggle(data.active);
        ...
        updateToggle: function updateToggle(active) {
            console.log('RAC ESTOY EN TOGGLE RADIO');
        ...
        setText: function setText(newText) {
            var textEntityX = this.guiItem.height - this.guiItem.width * 0.6;
            var textEntity = document.createElement("a-entity");
            this.textEntity = textEntity;
            textEntity.setAttribute('troika-text', 'value: ' + newText + '; \n                                                align:left; \n                                                anchor:left; \n                                                baseline:center;\n                                                letterSpacing:0;\n                                                color:' + this.data.fontColor + ';\n                                                font:' + this.data.fontFamily + ';\n                                                fontSize:' + this.data.fontSize + ';\n                                                depthOffset:1;\n                                                maxWidth:' + this.guiItem.width / 1.05 + ';\n                                                ');
            textEntity.setAttribute('position', textEntityX + ' 0 0.05');
    ...
    AFRAME.registerComponent('gui-slider', {
        ...
        init: function init() {
            ...
            el.addEventListener('click', function (evt) {
                ...
                var luzEscenario = document.getElementById('luzEscenario');
                luzEscenario.setAttribute('intensity', data.percent);
            });
        },
        update: function update() {},
        tick: function tick() {},
    ...
    //default colors
    window.key_orange = '#21ED3A'; // rgb(33, 91, 58) Light orange
    window.key_orange_light = '#237'; // rgb (239, 140, 96) Extra Light Orange
    ...
    window.key_offwhite = '#B6EBFC'; // rgb(211, 211, 212) Extra Light grey
